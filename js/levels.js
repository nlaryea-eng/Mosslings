...
const LEVELS = [
    ...
    {
        name: 'Bridge Tax', totalSpawn: 20, reqSaved: 12, time: 260, spawnRate: 48,
        par: { time: 170, skills: 10, saved: 20 },
        headlineSkill: SKILLS.BUILD,
        theme: 'FOREST',
        tut: 'Hard Mode begins. Chain builders early: the gaps are wider, but every drop between shelves is survivable.',
    ...
    {
        name: 'Basher\'s Hollow', totalSpawn: 18, reqSaved: 12, time: 230, spawnRate: 50,
        par: { time: 150, skills: 5, saved: 18 },
        headlineSkill: SKILLS.BASH,
        theme: 'CAVE',
    ...
    {
        name: 'Athlete Trial', totalSpawn: 14, reqSaved: 10, time: 240, spawnRate: 48,
        par: { time: 165, skills: 20, saved: 14 },
        headlineSkill: SKILLS.CLIMB,
        theme: 'CAVE',
    ...
    {
        name: 'Needle Mines', totalSpawn: 18, reqSaved: 10, time: 260, spawnRate: 52,
        par: { time: 175, skills: 6, saved: 18 },
        headlineSkill: SKILLS.MINE,
        theme: 'CAVE',
    ...
    {
        name: 'Twin Lava Leap', totalSpawn: 20, reqSaved: 12, time: 300, spawnRate: 50,
        par: { time: 190, skills: 14, saved: 20 },
        headlineSkill: SKILLS.BUILD,
        theme: 'VOLCANO',
    ...
    {
        name: 'Platform Ferry', totalSpawn: 12, reqSaved: 6, time: 260, spawnRate: 55,
        par: { time: 175, skills: 3, saved: 12 },
        headlineSkill: SKILLS.BLOCK,
        theme: 'CAVE',
        tut: 'New object: MOVING PLATFORM. Hold the colony back, then let a few ride the ferry across.',
        inventory: { [SKILLS.BLOCK]: 4, [SKILLS.BUILD]: 2, [SKILLS.FLOAT]: 4 },
    ...
    {
        name: 'Gatekeeper', totalSpawn: 16, reqSaved: 10, time: 220, spawnRate: 48,
        par: { time: 150, skills: 2, saved: 16 },
        headlineSkill: SKILLS.BLOCK,
        theme: 'FOREST',
        tut: 'New object: PRESSURE SWITCH. Turn one mossling into a BLOCKER [1] on the switch to hold the gate open.',
    ...
    {
        name: 'No Way Back', totalSpawn: 18, reqSaved: 12, time: 240, spawnRate: 50,
    ...
    {
        name: 'Spiral Quarry', totalSpawn: 20, reqSaved: 12, time: 300, spawnRate: 48,
        par: { time: 200, skills: 9, saved: 20 },
        headlineSkill: SKILLS.DIG,
        theme: 'CAVE',
    ...
    {
        name: 'Furnace Ferry', totalSpawn: 14, reqSaved: 8, time: 280, spawnRate: 54,
        par: { time: 190, skills: 3, saved: 14 },
        headlineSkill: SKILLS.BLOCK,
        theme: 'VOLCANO',
        tut: 'The ferry crosses lava. One blocker buys time; release the crowd only when the platform returns.',
        inventory: { [SKILLS.BLOCK]: 4, [SKILLS.FLOAT]: 6, [SKILLS.BUILD]: 2 },
    ...
    {
        name: 'Switch Lift', totalSpawn: 12, reqSaved: 6, time: 280, spawnRate: 56,
        par: { time: 190, skills: 3, saved: 12 },
        headlineSkill: SKILLS.BLOCK,
        theme: 'FOREST',
    ...
    {
        name: 'Moss Gauntlet', totalSpawn: 16, reqSaved: 10, time: 320, spawnRate: 48,
        par: { time: 220, skills: 24, saved: 16 },
        headlineSkill: SKILLS.CLIMB,
        theme: 'VOLCANO',
